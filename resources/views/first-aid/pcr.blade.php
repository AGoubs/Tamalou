  ...
  <div class="flex items-center justify-center py-8">
    <div class=" rounded overflow-hidden border w-full lg:w-8/12 md:w-10/12 bg-white mx-3 md:mx-0 lg:mx-0">
      ...
      <video controls  class="w-full bg-cover">
        <source src="{{ asset('videos/pcr.mp4') }}"
                type="video/mp4">
      ...
      <div class="px-3 pb-2">
        ...
        <div class="pt-1">
          <div class="mb-2 text-sm">
            <span class="font-medium mr-2">Victor Jullien</span> Voici une vidéo explicative pour réaliser un test PCR en toute sécurité
          </div>
        </div>
      </div>
    </div>
